...
test("all 4 answers should be different", () => {
    expect(getRandomAnswer()[0].answer).not.toEqual(getRandomAnswer()[1].answer)
    expect(getRandomAnswer()[0].answer).not.toEqual(getRandomAnswer()[2].answer)
    expect(getRandomAnswer()[0].answer).not.toEqual(getRandomAnswer()[3].answer)
    expect(getRandomAnswer()[1].answer).not.toEqual(getRandomAnswer()[2].answer)
    expect(getRandomAnswer()[1].answer).not.toEqual(getRandomAnswer()[3].answer)
    expect(getRandomAnswer()[2].answer).not.toEqual(getRandomAnswer()[3].answer)
})