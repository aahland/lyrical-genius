...
// This doesn't work Needs to be fixed
    ...
    let answers = [
        { firstObject: lyricResponse1.lyrics, song: answer[0].answer.song },
        { secondObject: lyricResponse2.lyrics, song: answer[1].answer.song },
        { thirdObject: lyricResponse3.lyrics, song: answer[2].answer.song },
        { fourthObject: lyricResponse4.lyrics, song: answer[3].answer.song }
    ]
    return answers
}
